...
class SnippetChannelPlot(BaseChannelPlot):
    ...
    value_data = Property(depends_on='source.added, source.updated, history')
    value_screen = Property(depends_on='source.added, source.updated, history')
    ...
    def _get_value_data(self):
        ...
        print 'updating'
        return self.source[-self.history:]

    @cached_property
    def _get_value_screen(self):
        print 'updating val screen'
    ...
    def _get_classifier_masks(self):
        ...
        classifiers = self.source.classifiers[-self.history:]
    ...
    def _render(self, gc):
        ...
        for i, mask in enumerate(self.classifier_masks):
            print 'vs', self.value_screen.shape
            print 'vss', self.value_screen[mask].shape
